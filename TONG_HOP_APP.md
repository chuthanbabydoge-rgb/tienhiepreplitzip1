...
## 6. THỐNG KÊ FILE
> **14 file** | **28,968 dòng** | **1.94 MB**

| File | Dòng | Kích thước | Vai trò |
|------|------|------------|---------|
| `server.js` | 1,789 | 79.2 KB | Backend — Express + Auth + Gemini AI + DB |
| `tienhiepv3.html` | 22,321 | 1.63 MB | Frontend chính — UI + Three.js 3D |
...
---
*Auto-generated bởi `generate-app-summary.js` lúc 03:06:21 3/6/2026 — Build xong feature → file tự cập nhật ✅*