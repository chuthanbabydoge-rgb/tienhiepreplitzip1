...
## 6. THỐNG KÊ FILE
> **14 file** | **28,311 dòng** | **1.91 MB**

| File | Dòng | Kích thước | Vai trò |
|------|------|------------|---------|
| `server.js` | 1,784 | 79.1 KB | Backend — Express + Auth + Gemini AI + DB |
| `tienhiepv3.html` | 21,669 | 1.60 MB | Frontend chính — UI + Three.js 3D |
...
---
*Auto-generated bởi `generate-app-summary.js` lúc 23:45:19 2/6/2026 — Build xong feature → file tự cập nhật ✅*